export const stateCityMap = {
  ...
  "Arunachal Pradesh": [
    ...
    "Dibang Valley", "Anjaw", "Lohit", "Changlang",
    "Tirap", "Longding"
  ],
  ...
  Chhattisgarh: [
    ...
    "Durg", "Gariaband", "Janjgir-Champa", "Jashpur",
  ...
  Punjab: [
    ...
    "Shahid Bhagat Singh Nagar", "Sri Muktsar Sahib",
    "Tarn Taran"
  ],
  ...
  "Uttar Pradesh": [
    ...
    "Shamli", "Shravasti", "Siddharthnagar",
